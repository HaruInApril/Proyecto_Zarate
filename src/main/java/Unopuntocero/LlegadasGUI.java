 ...
 * @author 202515
 */
public class LlegadasGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Llegada de vuelo");

        jLabel1.setText("Vuelo/Ruta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LlegadasGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LlegadasGUI().setVisible(true);
            }
        });
    }
