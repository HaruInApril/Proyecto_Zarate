...
public class Login extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jp_contrasena, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String contrasena = jp_contrasena.getText();
        usuario = usuario.toUpperCase();
        if(usuario.equals("UPIIG")&& contrasena.equals("aero123")){
            VisualGUI main = new VisualGUI();
            main.setVisible(true);
            this.setVisible(false);
        }
        else{
            JOptionPane.showMessageDialog(null, "Error \n credenciales incorrectas", "ERROR", JOptionPane.OK_OPTION);
        }
